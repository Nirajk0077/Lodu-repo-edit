...
DELETE_TIME = int(environ.get("DELETE_TIME", "600"))  #  deletion time in seconds (default: 10 minutes). Adjust as per your needs.
BUTTON_DELETE_TIME = int(environ.get("BUTTON_DELETE_TIME", "600"))
